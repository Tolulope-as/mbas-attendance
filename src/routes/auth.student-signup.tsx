...
//             return;
//           }
//           // Simulate biometric passkey payload.
//       const passkey_credential = {
//         credentialId: typeof crypto.randomUUID === 'function'
//           ? crypto.randomUUID()
//           : Math.random().toString(36).substring(2) + Date.now().toString(36),
//         registeredAt: new Date().toISOString(),
//         device: "biometric-simulated",
//       };
...
//             .from("students")
//             .insert({ full_name: fullName, matric_no: matricNo, passkey_credential });
//           if (insertErr) {
